...
%This method relies on calculating the areas of greatest variance (either 
%using a Sobel operator or first derivative function created by Piccinini) 
%and selecting them for the final image merge. Based on Piccinini's mehtod
