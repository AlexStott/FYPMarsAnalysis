...
parameters.ImageBaseName                    = 'Crop-0';         % Description: name of the image, without the final cardinal number. E.g.: 'ImageMesenchymal_' for the image: ImageMesenchymal_001.tif
parameters.ImageFolder                      = 'C:\FPICCININI\Dottorato\Other\TesiTirocini\2011_PolliniDavide\Materiale\StacksReali\StackFromIRST\Sferoide_RGB_8bit\';     % Description: absolute path where the images that should be processed are stored (the last character must be the slash). E.g.: 'C:\TestFolder\'
parameters.ImageFormat                      = '.tif';               % Description: format of the images. E.g.: '.jpg' or '.bmp' or '.tif' or etc.
parameters.ImageIndexes                     = [1:26];      % Description: cardinal numbers of the images that should be processed. E.g.: [001, 003, 004] to process the images named ImageMesenchymal_001.tif, ImageMesenchymal_003.tif and ImageMesenchymal_004.tif
